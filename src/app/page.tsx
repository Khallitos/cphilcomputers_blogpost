        ...
        <div className="mx-auto w-full max-w-4xl py-24">
          ...
          <div className="mt-10 flex flex-col items-center gap-10 sm:flex-row sm:items-start">
            ...
            <div className="space-y-4 text-base leading-relaxed text-foreground/90">
              <p>
                Experienced IT professional with a five-year background
                spanning IT support, enterprise networking, and workflow
                automation across the banking, oil and gas, and software
                industries. Proven track record of keeping mission-critical
                infrastructure running smoothly, resolving escalations quickly,
                and using automation to make IT operations faster, safer, and
                more efficient.
              </p>
            </div>
          </div>
